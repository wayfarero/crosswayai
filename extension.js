...
const { generateDependencyMap } = require('./js/dependencyMap');
const { generateIncludeDiagram } = require('./js/includeDiagram');
const { generateImpactDiagram } = require('./js/impactDiagram');
const { sendToMermaid } = require('./js/sendToMermaid');
const { createMermaidViewer } = require('./js/mermaidviewer');
